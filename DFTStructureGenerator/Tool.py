...
# disabled by repo-wide static call scan: remove_same
...
# disabled by repo-wide static call scan: save_load
...
# disabled by repo-wide static call scan: clean_nan
# def clean_nan(input_list):
#     return np.nan_to_num(input_list, nan=0)

# disabled by repo-wide static call scan: get_array_cos
...
# disabled by repo-wide static call scan: get_torsion
...
# disabled by repo-wide static call scan: stablize_smileses
